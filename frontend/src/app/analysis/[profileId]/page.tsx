                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">{data.profile_data.citation_timeline.total_years}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 mt-4">
                  ...
                  <div className="space-y-3">
                    {data.profile_data.citation_timeline?.yearly_citations && (() => {
                      ...
                      // Peak analysis
                      const peakCitations = Math.max(...values);
                      const peakYear = completeYears[values.indexOf(peakCitations)];
                      const yearsSincePeak = 2024 - peakYear;
                      ...
                      // Average citations over career
                      const avgCitations = Math.round(values.reduce((a, b) => a + b, 0) / values.length);
                      
                      return (
                        <>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Early Career Avg:</span>
                            <span className="font-bold">{Math.round(avgEarly)} citations/year</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Recent Avg:</span>
                            <span className="font-bold">{Math.round(avgRecent)} citations/year</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Career Growth:</span>
                            <span className="font-bold">
                              {careerGrowth > 0 ? '+' : ''}{Math.round(careerGrowth)}%
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Career Average:</span>
                            <span className="font-bold">{avgCitations} citations/year</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Recent Trend:</span>
                            <span className="font-bold">{trendDirection}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Years Since Peak:</span>
                            <span className="font-bold">{yearsSincePeak} years</span>
                          </div>
                        </>
                      );
                    })()}
                ...
                <div className="bg-gradient-to-br from-orange-50 to-amber-100 rounded-lg p-4 mt-4">
                  ...
                  <div className="space-y-3">
                    {data.profile_data.citation_timeline?.yearly_citations && (() => {
                      ...
                      const yearEndProjection = Math.round(current2025 / monthProgress);
                      ...
                      return (
                        <>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Current (thru July):</span>
                            <span className="font-bold text-orange-600">{current2025}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Year-end Projection:</span>
                            <span className="font-bold text-orange-700">{yearEndProjection}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Based on Trend:</span>
                            <span className="font-bold text-amber-600">{Math.round(avgRecent)}</span>
                          </div>
                          <div className="text-xs text-gray-600 mt-2 p-2 bg-white/50 rounded">
                            Projection assumes steady monthly rate through year-end. Trend-based uses 2022-2024 average.
                          </div>
                        </>
                      );
                    })()}
                                  ...
                                  <div key={year} className="flex flex-col items-center" style={{ width: `${100 / Object.keys(data.profile_data.citation_timeline?.yearly_citations || {}).length}%` }}>
                                    <div className="flex flex-col items-center w-full">
                                      ...
                                      <div className="text-xs text-gray-600 text-center">
                                        ...
                                        <span className="block sm:hidden transform -rotate-45 origin-center text-[10px]" style={{ writingMode: 'horizontal-tb' }}>
                                          {year}
                                        </span>
                                      </div>
                                    </div>
